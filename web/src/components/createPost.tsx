...
{
  one === true ? null :       <div className="relative w-full group" >    
  <div
    className={isDarkMode === true ? "relative z-40 cursor-pointer group-hover:translate-x-8 group-hover:shadow-2xl group-hover:-translate-y-8 transition-all duration-500 bg-neutral-900 flex items-center justify-center h-32 w-32 mx-auto rounded-xl" : "relative z-40 cursor-pointer group-hover:translate-x-8 group-hover:shadow-2xl group-hover:-translate-y-8 transition-all duration-500 bg-gray-300 flex items-center justify-center h-32 w-32 mx-auto rounded-xl"}
  >
      <input
        type="file"
        multiple
              ...
              <Carousel className="overflow-hidden">
                <CarouselContent>
                  {uploadedImages.map((img, index) => (
                    <CarouselItem  className=" basis-1/2 gap-1 h-auto max-w-full  overflow-hidden" key={index}>
                  <img
            key={index}
            src={img}
